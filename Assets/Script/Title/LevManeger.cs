    ...
    public void LevelText()
    {
        switch (Level)
        {
            case easy:
                ...
                TitleManager.levelText.color = new Color(0f, 1f, 0.2f, 1f);
                
                break;
            case normal:
                TitleManager.levelText.text = "NORMAL";
                TitleManager.levelText.color = new Color(1f, 1f, 0f, 1f);
               
                break;
            case hard:
                TitleManager.levelText.text = "HARD";
                TitleManager.levelText.color = new Color(1f, 0f, 0f, 1f);
